...
class ApplicationStatusRepository implements ApplicationStatusRepositoryInterface
{
    ...
    {
        // Always return true in development/local environment
    ...
    {
        // Always return Extended License in development/local environment
        if (config('app.env') !== 'production') {
    ...
    {
        // Always pass check in development/local environment
        if (config('app.env') !== 'production') {
            $portal = $this->portal() ?: [];
