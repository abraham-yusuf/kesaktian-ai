...
(1, 'default', NULL, NULL, 0, NULL, NULL, 'en', 'en', 'Extended License', 'dummy-license-key-12345', 'backend', 'public', 'en-US', 'stable-diffusion-xl-1024-v1-0', NULL, 'dall-e-3', 0, 2, 0, 1, NULL, NULL, 0, 1, 0, NULL, 'disabled', NULL, 'bottom-left', 1, 10, 1, 0, 'stability.stable-diffusion-xl-v1');
